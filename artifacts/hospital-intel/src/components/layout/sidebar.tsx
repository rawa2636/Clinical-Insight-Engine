...
import { LayoutDashboard, FilePlus2, Activity, Settings, LogOut, Video, ArrowLeftRight, Stethoscope, Navigation } from "lucide-react";
...
const navigation = [
  ...
  { name: "Referral Pathway", nameAr: "مسار الإحالة", href: "/referral-pathway", icon: Navigation },
